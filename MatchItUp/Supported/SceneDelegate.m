...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    GlobalVar.sharedInstance.appWindow = self.window;
    ZHPopupViewManager.sharedManager;
    self.window.rootViewController = [[RootTabbarController alloc]init];
    //if ([NSUserDefaults.standardUserDefaults boolForKey:@"isOn"]){
//    CameraViewController *vc = [[CameraViewController alloc] init];
//    ModelPlayController *vc = [[ModelPlayController alloc] init];
////    AlbumViewController *vc = [[AlbumViewController alloc]init];
//    BaseNavigationControllerViewController *navigationControler = [[BaseNavigationControllerViewController alloc]init];
////    vc.title = @"我的相册";
